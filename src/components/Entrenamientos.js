...
import flexi from '../assets/flexi2.jpg';
        ...
        <div className="container">
            <div className="content" style={{ padding: '20px', position: 'relative', overflow: 'hidden', flex: '1 0 auto' }}>
                ...
                <div className={`section ${visibleSection === 1 ? 'fade' : ''}`}>
                    ...
                    <img src={fuerza} alt="Entrenamiento de Fuerza" style={{ width: '100%', height: 'auto' }} />
                ...
                <div className={`section ${visibleSection === 2 ? 'fade' : ''}`}>
                    ...
                    <img src={cardio} alt="Entrenamiento Cardiovascular" style={{ width: '100%', height: 'auto' }} />
                ...
                <div className={`section ${visibleSection === 3 ? 'fade' : ''}`}>
                    ...
                    <img src={flexi} alt="Entrenamiento de Flexibilidad" style={{ width: '90%', height: 'auto' }} />
